            ...
            <div className="usersDiv">
                    {
                        moduleOne?
                    mockedData.map(e =>
                        e.content_module.authz_provider_1.map(e =><div className="users">{e}</div>)
                        ) :
                        moduleTwo?
                        mockedData.map(e =>
                            e.content_module.authz_provider_2.map(e =><div className="users">{e}</div>)
                            ) :
                            moduleThree?
                            mockedData.map(e =>
                                e.content_module.authz_provider_3.map(e =><div className="users">{e}</div>)
                                ) :
                                moduleFour?
                                mockedData.map(e =>
                                    e.content_module.authz_provider_4.map(e =><div className="users">{e}</div>)
                                    ) : null
                    }
            </div>
